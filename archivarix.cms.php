  ...
  switch ($cli['action']) {
    case 'help':
      showWarningJson([
        'action'  => $cli['action'],
        'status'  => 1,
        'message' => 'A list of available actions and details with examples',
        'actions' => [
          'api.cloudflare.create'      => '',
          'api.cloudflare.purge.cache' => '',
          'api.cloudflare.remove'      => '',
          'broken.encoded.urls'        => '',
          'broken.images.remove'       => '',
          'broken.links.remove'        => '',
          'change.domain'              => '',
          'change.uuid'                => '',
          'check.prereqs'              => '',
